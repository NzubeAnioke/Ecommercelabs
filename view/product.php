...
<br>  <br><br>
        ...
        <div class="d-flex justify-content-center">
            <button type="submit" name="product" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">Add Product</button>
        </div>
    </form>

    <a href="update_productdisplay.php">Edit product</a>
